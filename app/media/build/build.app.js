...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wow = __webpack_require__(30);
	...
	var App = function () {
		...
		_createClass(App, [{
			key: 'init',
			value: function init() {
				new _gallery2.default(document.querySelector('.baol-masonry'));
				new _header2.default();
				new _wow2.default(document.querySelector('.baol-preloads'));
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _masonryLayout = __webpack_require__(21);
	...
	var Gallery = function (_Helper) {
		_inherits(Gallery, _Helper);
		...
		function Gallery(el) {
			...
			window.addEventListener('scroll', _this.scrollHandler.bind(_this));
		...
		_createClass(Gallery, [{
			...
			value: function scrollHandler() {
				var heightToload = document.body.clientHeight - document.body.scrollTop;
			...
			value: function requestHandler() {
				this.xhrRequest('GET', '/site/gallery?offset=' + this.offset, null, null, this.afterReques.bind(this));
			}
		}, {
			key: 'afterReques',
			value: function afterReques(obj) {
				var json = void 0;
				try {
					json = JSON.parse(obj);
			...
			value: function generateTemplate(json) {
			...
			key: 'appendToPage',
			value: function appendToPage(str) {

				var documentBlock = document.createElement('div');

				documentBlock.insertAdjacentHTML('beforeend', str);

				var childrens = documentBlock.children;

				console.log(childrens);

				for (var i = 0, l = childrens.length; i < l; i++) {
					var cloned = childrens[i].cloneNode(true);
				...
				if (!this.msnry) {
					...
					this.msnry = new _masonryLayout2.default(this.elem, {
			...
			key: 'templateMasonry',
			value: function templateMasonry(json) {
				var tmp = '<figure class="baol-item-grid effect-chico">' + '<figcaption>' + '<h3>' + json.title + '</h3>' + '<p> ' + json.size_and_year + ' <br /> ' + json.description + '</p>' + '</figcaption>' + '<img src="' + json.image + '" />' + '</figure>';
...
/***/ function(module, exports) {
	...
	var Header = function () {
		...
		_createClass(Header, [{
			key: 'scrollHeaders',
			value: function scrollHeaders(event) {
			...
			key: 'menuHandler',
			value: function menuHandler(event) {
